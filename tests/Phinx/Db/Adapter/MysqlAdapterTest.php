...
class MysqlAdapterTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testSqlPositionalParams($params)
    {
        ...
        $this->assertEquals(1,
            $this->adapter->execute('INSERT INTO ntable (realname, email, yob) VALUES (?, ?, ?)', $params));
    ...
    public function testSqlNamedParams($params)
    {
        ...
        $this->assertEquals(true, $this->adapter->execute('DELETE FROM ntable WHERE 1=1'));
        $this->assertEquals(1,
            $this->adapter->execute('INSERT INTO ntable (realname, email, yob) VALUES (:val1, :val2, :val3)', $params));
        $pdoStmt = $this->adapter->query('SELECT * FROM ntable WHERE realname = :val1 AND email = :val2 AND yob = :val3',
            $params);
        $this->assertInstanceOf('PDOStatement', $pdoStmt);
        $this->assertCount(1, $pdoStmt->fetchAll());
    }
