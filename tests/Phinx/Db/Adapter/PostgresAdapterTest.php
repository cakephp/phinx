...
class PostgresAdapterTest extends TestCase
{
    ...
    public function testDumpCreateTable()
    {
        ...
        if ($this->usingPostgres10()) {
            $expectedOutput = 'CREATE TABLE "public"."table1" ("id" INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY, "column1" CHARACTER VARYING ' .
                'NULL, "column2" INTEGER NULL, "column3" CHARACTER VARYING NOT NULL  DEFAULT \'test\', CONSTRAINT ' .
                '"table1_pkey" PRIMARY KEY ("id"));';
        } else {
            $expectedOutput = 'CREATE TABLE "public"."table1" ("id" SERIAL NOT NULL, "column1" CHARACTER VARYING ' .
                'NULL, "column2" INTEGER NULL, "column3" CHARACTER VARYING NOT NULL  DEFAULT \'test\', CONSTRAINT ' .
                '"table1_pkey" PRIMARY KEY ("id"));';
        }
    ...
    public function testDumpCreateTableWithSchema()
    {
        ...
        if ($this->usingPostgres10()) {
            $expectedOutput = 'CREATE TABLE "schema1"."table1" ("id" INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY, "column1" CHARACTER VARYING ' .
                'NULL, "column2" INTEGER NULL, "column3" CHARACTER VARYING NOT NULL  DEFAULT \'test\', CONSTRAINT ' .
                '"table1_pkey" PRIMARY KEY ("id"));';
        } else {
            $expectedOutput = 'CREATE TABLE "schema1"."table1" ("id" SERIAL NOT NULL, "column1" CHARACTER VARYING ' .
                'NULL, "column2" INTEGER NULL, "column3" CHARACTER VARYING NOT NULL  DEFAULT \'test\', CONSTRAINT ' .
                '"table1_pkey" PRIMARY KEY ("id"));';
        }
        $actualOutput = $consoleOutput->fetch();
...
OUTPUT;
    ...
    public function testDumpCreateTableAndThenInsert()
    {
        ...
        $expectedOutput = <<<'OUTPUT'
CREATE TABLE "schema1"."table1" ("column1" CHARACTER VARYING NOT NULL, "column2" INTEGER NULL, CONSTRAINT "table1_pkey" PRIMARY KEY ("column1"));
